...
public class Sky {
    ...
    private static Map<String, Sky> sky = new HashMap<>();
    static {
        ...
        sky.put("WIND", new Sky("大风", R.drawable.ic_cloudy, R.drawable.bg_cloudy));
        ...
        sky.put("MODERATE_HAZE", new Sky("中毒雾霾", R.drawable.ic_moderate_haze, R.drawable.bg_fog));
    ...
    public static Sky getSky(String skycon) {
        if (sky.get(skycon) != null) {
            return sky.get(skycon);
        }
        return sky.get("CLEAR_DAY");
    }
